...
const FileScreen({Key? key, required this.repoId, required this.path}) : super(key: key);
                    ...
                    : SingleChildScrollView(
                        ...
                        children: [
                            ...
                            padding: EdgeInsets.symmetric(
                                horizontal: MediaQuery.of(context).size.width * 0.1, // 左右に10%のパディング
                            ),
                            child: Container(
                                ...
                                itemBuilder: (context, index) {
                                    ...
                                    final lineContent = fileContent!.split('\n')[index];
                                    return Row(
